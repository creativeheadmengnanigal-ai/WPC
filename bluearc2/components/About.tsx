  ...
  return (
    <section id="about" ref={ref} className="about-section">
      ...
      <div className="about-container">
        ...
        <div>
          <div className="reveal">
            ...
            <h2 className="about-heading">
              Trusted Contractor<br />
              <span className="gradient-text gradient-1">Across the Region.</span>
            </h2>
          </div>
            ...
            <div className="about-card">
              <div className="about-icon-wrapper">
                <svg viewBox="0 0 22 22" fill="none" width="18" height="18">
                  <path d="M11 2L14 7L20 8L15 13L16 19L11 16L6 19L7 13L2 8L8 7Z" stroke="white" strokeWidth="1.5" strokeLinejoin="round" fill="none"/>
                </svg>
              </div>
              <div>
                <h3 className="about-card-title">Our Mission</h3>
                <p className="about-card-text">
                  To provide high-quality welding and protective coating solutions that meet client requirements while ensuring safety, efficiency, and long-term asset protection.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="about-card">
              <div className="about-icon-wrapper">
                <svg viewBox="0 0 22 22" fill="none" width="18" height="18">
                  ...
                  <path d="M11 6V11L14 13" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              </div>
              <div>
                <h3 className="about-card-title">Our Vision</h3>
                <p className="about-card-text">
                  To become a trusted and preferred contractor in welding and industrial painting services across the UAE and the Middle East.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Values */}
        <div>
          <h3 className="about-values-title reveal">Core Values</h3>
          <div className="about-values-grid">
            {values.map((v, i) => (
              <div 
                key={v.v} 
                className={`reveal rd${Math.min(i + 1, 6)} about-value-item`}
              >
                <span className="about-value-icon">{v.icon}</span>
                <span className="about-value-label">{v.v}</span>
              </div>
            ))}
          </div>
        </div>
