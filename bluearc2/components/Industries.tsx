...
export default function Industries() {
  ...
  return (
    <section id="industries" ref={ref} className="industries-section">
      <div className="industries-grid-bg" />
      <div className="industries-container">
        <div className="industries-header reveal">
          <span className="industries-badge">Sectors We Serve</span>
          <h2 className="industries-title">Industries We Work In</h2>
        </div>
        ...
        <div className="industries-grid">
          {items.map((item, i) => (
            <div 
              key={item.name} 
              className={`reveal rd${Math.min(i + 1, 6)} industries-item`}
            >
              <span className="industries-icon">{item.icon}</span>
              <h3 className="industries-item-title">{item.name}</h3>
              <p className="industries-item-desc">{item.desc}</p>
            </div>
          ))}

          {/* CTA card */}
          <div className="industries-cta reveal rd6 float">
            <div>
              <h3 className="industries-cta-title">Ready to start?</h3>
              <p className="industries-cta-desc">Tell us about your project requirements.</p>
            </div>
