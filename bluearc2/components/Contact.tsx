    ...
    <section id="contact" ref={ref} className="contact-section">
      <div className="contact-container">
        <div className="contact-grid">
          ...
          <div>
            <div className="reveal">
              ...
              <h2 className="contact-heading">
                Let's Build<br />
                <span className="contact-heading-gradient">Something Solid.</span>
              </h2>
          ...
          {/* Form */}
          <div className="contact-form-wrapper reveal rd2">
            <div className="contact-form-inner">
              ...
              {status === "sent" ? (
                <div className="contact-success">
                  ...
                  <p className="contact-success-desc">We'll get back to you within 24 hours.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="contact-form">
                  ...
                  <button 
                    ...
                    className="contact-submit btn-shimmer"
                  >
                    {status === "sending" ? "Sending…" : "Send Enquiry →"}
                  </button>
                  <p className="contact-note">Typically respond within 24 business hours</p>
                </form>
              )}
            </div>
          </div>
